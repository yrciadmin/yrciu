  ...
  return (
    <section className='flex flex-col mt-12 items-center'>
        ...
        <div className='flex sm:flex-row flex-col items-center w-full justify-center sm:justify-around mt-8'>
            <Card icon icon_img={Icon} className='p-4 border-mustard-yellow  shadow-xl shadow-mustard-shadow mb-8 sm:mb-0' iconClassName='bg-mustard-yellow'>
            ...
            <Card icon icon_img={Icon2} className='p-4 border-yrci-red mb-8 sm:mb-0 shadow-xl shadow-red-shadow' iconClassName='bg-yrci-red'>
                {/* <h1 className='font-bold'>Boost Your Credentials:</h1> */}
