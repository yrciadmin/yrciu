    ...
    <section className='flex-col sm:flex-row flex justify-between items-center lg:mx-24'>
        <div className='w-full sm:p-0 xl:w-1/2 flex items-center'>
            <div className='flex flex-col'>
                <div className='px-4 xl:px-0 bg-hero-bg-mobile bg-cover bg-center md:bg-none flex flex-col justify-center h-40 md:h-fit'>
                    <h1 className='font-bold md:text-4xl lg:text-6xl text-3xl'>Maximize Your Professional Value</h1>
                    <h1 className='font-bold md:text-4xl lg:text-6xl text-3xl text-yrci-red mb-8'>with YRCI University</h1>
                </div>
                ...
                <LinkButton link='https://yrciuniversity.docebosaas.com/learn' className='self-end text-white text-center text-lg sm:self-start sm:w-fit sm:px-8 mx-8 xl:mx-0 bg-yrci-red'>Learn More</LinkButton>
            </div>
        </div>
