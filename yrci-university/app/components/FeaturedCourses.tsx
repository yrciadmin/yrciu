...
const FeaturedCourses = () => {
  return (
    <section className='bg-featured-courses w-full mt-16'>
        <div className='flex justify-center'><Heading>Featured Courses</Heading></div>
        ...
        <div className='flex flex-wrap justify-center mt-8'>
            ...
            <div className='w-[430] py-8 px-5 bg-white border-2 border-light-gary flex-flex-col rounded-lg h-[612px] m-10'>
                <Image
                    ...
                    alt="Course One"
                />
                <h1 className='my-3 font-semibold text-xl uppercase w-[390px] border-b border-dark-gray pb-3'>Delegated Examining Certification Preparatory Course</h1>
              ...
              <div className='w-[430] py-8 px-5 bg-white border-2 border-light-gary flex-flex-col rounded-lg h-[612px] m-10'>
                <Image
                    ...
                    alt="Course One"
                />
                <h1 className='my-3 font-semibold text-xl uppercase w-[390px] border-b border-dark-gray pb-3'>Hiring Authorities</h1>
                <div className='flex flex-col w-[390px]'>
                    <div className='flex justify-between'>
                        <h1 className='w-[81.11px] text-neutral-400 text-[13px] font-bold capitalize'>Time:</h1>
                ...
                <LinkButton link="https://yrciuniversitysandbox.docebosaas.com/learn/courses/110/hiring-authorities" className="w-[390px] h-10 p-2.5 bg-white hover:bg-yrci-red rounded-lg shadow border border-red-600 justify-center items-center gap-2.5 inline-flex hover:text-white text-yrci-red text-base font-bold uppercase mt-8">Start Learning</LinkButton>
            </div>
            ...
            <div className='w-[430] py-8 px-5 bg-white border-2 border-light-gary flex-flex-col rounded-lg h-[612px] m-10'>
                <Image
                    ...
                    alt="Course One"
                />
                <h1 className='my-3 font-semibold text-xl uppercase w-[390px] border-b border-dark-gray pb-3'>Veterans’ Preference</h1>
                <div className='flex flex-col w-[390px]'>
                    <div className='flex justify-between'>
                        <h1 className='w-[81.11px] text-neutral-400 text-[13px] font-bold capitalize'>Time:</h1>
                        <p className='w-[160.49px] text-right text-black text-lg font-boldcapitalize'>17hr 43min</p>
            ...
            <div className='w-[430] py-8 px-5 bg-white border-2 border-light-gary flex-flex-col rounded-lg h-[612px] m-10'>
                <Image
                    ...
                    alt="Course One"
                />
                <h1 className='my-3 font-semibold text-xl uppercase w-[390px] border-b border-dark-gray pb-3'>Exploring the Delegated Examining Operations Handbook (DEOH)</h1>
                <div className='flex flex-col w-[390px]'>
                    <div className='flex justify-between'>
                        <h1 className='w-[81.11px] text-neutral-400 text-[13px] font-bold capitalize'>Time:</h1>
                        <p className='w-[160.49px] text-right text-black text-lg font-boldcapitalize'>17hr 43min</p>
