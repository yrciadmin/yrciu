...
const data = [
    ...
    { id: 2, title: 'HIRING AUTHORITIY', image: `bg-course-2`, link: `https://yrciuniversity.docebosaas.com/learn/courses/8/hiring-authorities`, content: `Learn about the Federal government's competitive hiring process, hiring authorities in the excepted service, and information for current and former Federal employees. Equip yourself with the knowledge to effectively explain hiring authorities to hiring managers and make informed recommendations for staffing decisions.` },
    { id: 3, title: 'VETERANS’ PREFERENCE',  image: `bg-course-3`, link: `https://yrciuniversity.docebosaas.com/lea rn/courses/90/veterans-preference`, content: `Enroll in our self-guided e-learning course to elevate your understanding of Veterans’ Preference in the Federal hiring process. Gain a comprehensive understanding of its benefits, legal framework, and verification techniques.`},
