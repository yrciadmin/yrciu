...
const data = [
    {id: 1, value: "EXCELLENT" ,content: `The hands on activities really made the topics stick. Additionally, the training was collaborative where participation was encouraged.`, title: `DE Test Prep`},
