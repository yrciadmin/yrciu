...
const WhyChooseUs = () => {
    return (
        <section className='flex flex-col mt-12 items-center 2xl:justify-around mx-4 md:mx-8 2xl:mx-24 pb-8'>
            ...
            <motion.div
                ...
                className='lg:flex hidden lg:flex-row flex-col items-center w-full justify-center sm:justify-around mt-8 md:overflow-y-auto xl:overflow-hidden'
            >
                <motion.div
                    variants={slideInFromBottom}
                >
                    <Card icon icon_img={Icon} title="Boost Your Credentials" className='bg-[#F7E8D1] h-[380.05px] xl:h-[370.05px] xl:w-[370px] 2xl:h-[390.05px] xl:mx-0 p-4 border-mustard-yellow mb-8 sm:mb-0 shadow-2xl shadow-mustard-shadow' iconClassName='bg-mustard-yellow'>
